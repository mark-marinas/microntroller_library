...
#if (PLL1_SETUP)
  LPC_LPC_SC->PLL1CFG   = PLL1CFG_Val;
  LPC_LPC_SC->PLL1CON   = 0x01;             /* PLL1 Enable                        */
  LPC_LPC_SC->PLL1FEED  = 0xAA;
  LPC_LPC_SC->PLL1FEED  = 0x55;
  while (!(LPC_LPC_SC->PLL1STAT & (1<<10)));/* Wait for PLOCK1                    */

  LPC_LPC_SC->PLL1CON   = 0x03;             /* PLL1 Enable & Connect              */
  LPC_LPC_SC->PLL1FEED  = 0xAA;
  LPC_LPC_SC->PLL1FEED  = 0x55;
#else
